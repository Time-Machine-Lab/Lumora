...
export const BROWSER_RESERVED_SHORTCUTS: readonly ReservedBrowserShortcut[] = [
  ...
  { shortcut: 'Ctrl+Shift+B', browsers: WINDOWS_BROWSERS, action: '显示或隐藏书签栏' },
  { shortcut: 'Ctrl+Shift+O', browsers: WINDOWS_BROWSERS, action: '打开书签管理器' },
  { shortcut: 'Ctrl+Shift+D', browsers: WINDOWS_BROWSERS, action: '收藏所有打开的标签页' },
  ...
  { shortcut: 'Alt+E', browsers: ['Chrome'], action: '打开浏览器菜单' },
  { shortcut: 'Alt+F', browsers: WINDOWS_BROWSERS, action: '打开浏览器菜单' },
  { shortcut: 'Alt+F4', browsers: WINDOWS_BROWSERS, action: '关闭窗口' },
  { shortcut: 'Alt+Space', browsers: WINDOWS_BROWSERS, action: '打开系统窗口菜单' },
  ...
  { shortcut: 'Cmd+D', browsers: MAC_BROWSERS, action: '添加书签' },
  { shortcut: 'Cmd+H', browsers: MAC_BROWSERS, action: '隐藏当前应用' },
  { shortcut: 'Cmd+M', browsers: MAC_BROWSERS, action: '最小化当前窗口' },
  { shortcut: 'Cmd+Space', browsers: MAC_BROWSERS, action: '打开系统搜索' },
  { shortcut: 'Cmd+Shift+B', browsers: MAC_BROWSERS, action: '显示或隐藏书签栏' },
  { shortcut: 'Cmd+Shift+D', browsers: MAC_BROWSERS, action: '收藏所有打开的标签页' },
  { shortcut: 'Cmd+Shift+P', browsers: ['Firefox (macOS)'], action: '新建隐私窗口' },
  ...
  { shortcut: 'Cmd+Alt+B', browsers: ['Chrome (macOS)'], action: '打开书签管理器' },
  ...
  { shortcut: 'Cmd+Shift+[', browsers: ['Safari'], action: '切换到上一个标签页' },
  { shortcut: 'Cmd+Shift+]', browsers: ['Safari'], action: '切换到下一个标签页' },
